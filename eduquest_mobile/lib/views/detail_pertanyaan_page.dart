...
class _DetailPertanyaanPageState extends State<DetailPertanyaanPage> {
  ...
  Future<void> _loadAnswersAndAuthor() async {
    ...
    final authorList = await db.query(
      'users',
      where: 'username = ?',
      whereArgs: [widget.question['username']],
    );
  ...
  Future<void> _toggleLikeAnswer(Map<String, dynamic> answer) async {
    ...
    if (isLiked) {
      await db.rawUpdate('UPDATE answers SET likes = likes - 1 WHERE id = ?', [
        answerId,
      ]);
    ...
    if (mounted) {
      ...
      if (index != -1) {
        setState(() {
          // 1. Buat salinan LIST baru yang modifiable dari _answers
          final List<Map<String, dynamic>> mutableList =
              List<Map<String, dynamic>>.from(_answers);

          // 2. Buat salinan MAP baru dari item yang mau diubah
          final Map<String, dynamic> mutableAnswer = Map<String, dynamic>.from(
            mutableList[index],
          );

          // 3. Update jumlah likes pada map baru
          mutableAnswer['likes'] = (mutableAnswer['likes'] as int) + delta;

          // 4. Masukkan map baru ke list baru, lalu ganti list lama secara utuh
          mutableList[index] = mutableAnswer;
          _answers = mutableList;
        });
      }
    }
  }
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        child: Row(
                          children: [
                            CircleAvatar(
                              ...
                              backgroundImage:
                                  (authorImg != null && authorImg.isNotEmpty)
                                  ? FileImage(File(authorImg))
                                  : null,
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  widget.question['created_at'].toString(),
                                  style: TextStyle(
                      ...
                      if (widget.question['image_path'] != null &&
                          widget.question['image_path'].toString().isNotEmpty)
                        Padding(
                          padding: const EdgeInsets.only(top: 16),
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(12),
                            child: Image.file(
                              File(widget.question['image_path']),
                ...
                if (_displayedAnswers.isEmpty)
                  ...
                  ..._displayedAnswers.map((answer) {
                    bool isAnswerLiked =
                        _prefs?.getBool(
                          'liked_a_${answer['id']}_${widget.user.username}',
                        ) ??
                        false;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: Row(
                              ...
                              children: [
                                Row(
                                  children: [
                                    CircleAvatar(
                                      ...
                                      backgroundImage:
                                          (ansAuthorImg != null &&
                                              ansAuthorImg.isNotEmpty)
                                          ? FileImage(File(ansAuthorImg))
                                          : null,
                                      child:
                                          (ansAuthorImg == null ||
                                              ansAuthorImg.isEmpty)
                                          ? const Icon(
                                              Icons.person,
                                              size: 16,
                                              color: Colors.white,
                                ...
                                Text(
                                  answer['created_at'].toString().split(' ')[0],
                                  style: TextStyle(
                          ...
                          if (answer['image_path'] != null &&
                              answer['image_path'].toString().isNotEmpty)
                            Padding(
                              padding: const EdgeInsets.only(top: 12),
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(12),
                                child: Image.file(
                                  File(answer['image_path']),
                                  height: 150,
                                  width: double.infinity,
                                  fit: BoxFit.cover,
                                ),
